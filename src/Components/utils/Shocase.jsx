...
function Shocase () {
  return (
    <div
      ...
      className='bg-fixed top-0 left-0 w-full h-full bg-center bg-no-repeat bg-cover px-2 py-12 md:p-28'
    >
      <div className='w-full md:w-1/2'>
        <h1 className='text-white text-3xl md:text-6xl font-semibold'>Playtime Paradise</h1>
